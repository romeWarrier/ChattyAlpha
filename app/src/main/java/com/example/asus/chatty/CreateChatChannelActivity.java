...
public class CreateChatChannelActivity extends AppCompatActivity
        ...
        protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            if (savedInstanceState == null) {
                ...
                manager.beginTransaction()
                        .replace(R.id.container_create_chat_channel, fragment)
                        .commit();
            }

            mNextButton = (Button) findViewById(R.id.button_create_chat_channel_next);
            ...
            mCreateButton = (Button) findViewById(R.id.button_create_chat_channel_create);
            mCreateButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (mCurrentState == STATE_SELECT_USERS) {
//                if (mCurrentState == STATE_SELECT_DISTINCT) {
                        mIsDistinct = PreferenceUtils.getChatChannelDistinct();
            ...
            mToolbar = (Toolbar) findViewById(R.id.toolbar_create_chat_channel);
