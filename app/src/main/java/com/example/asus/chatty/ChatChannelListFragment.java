...
public class ChatChannelListFragment extends Fragment {
    ...
    public static ChatChannelListFragment newInstance() {
        ChatChannelListFragment fragment = new ChatChannelListFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_chat_channel_list, container, false);

        setRetainInstance(true);

        // Change action bar title
        ((MainActivity) getActivity()).setActionBarTitle("Chat Channel");

        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.recycler_chat_channel_list);
        mCreateChannelFab = (FloatingActionButton) rootView.findViewById(R.id.fab_chat_channel_list);
        mSwipeRefresh = (SwipeRefreshLayout) rootView.findViewById(R.id.swipe_layout_chat_channel_list);
        ...
        mCreateChannelFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), CreateChatChannelActivity.class);
                startActivityForResult(intent, INTENT_REQUEST_NEW_GROUP_CHANNEL);
            }
        });

        mChannelListAdapter = new ChatChannelListAdapter(getActivity());
    ...
    private void setUpChannelListAdapter() {
        mChannelListAdapter.setOnItemClickListener(new ChatChannelListAdapter.OnItemClickListener() {
            @Override
        ...
        mChannelListAdapter.setOnItemLongClickListener(new ChatChannelListAdapter.OnItemLongClickListener() {
            @Override
    ...
    void enterGroupChannel(String channelUrl) {
        ...
        getFragmentManager().beginTransaction()
                .replace(R.id.container_chat_channel, fragment)
                .addToBackStack(null)
                .commit();
    }
