...
import com.example.asus.chatty.sample.groupchannel.SelectableUserListAdapter;
...
public class BlockedMemberListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blocked_member_list);
