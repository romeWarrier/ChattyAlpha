...
import com.example.asus.chatty.utils.MediaPlayerActivity;
import com.example.asus.chatty.utils.PhotoViewerActivity;
import com.example.asus.chatty.utils.TextUtils;
import com.example.asus.chatty.utils.UrlPreviewInfo;
import com.example.asus.chatty.utils.WebUtils;
...
public class ChatFragment extends Fragment {
    ...
    public static ChatFragment newInstance(@NonNull String channelUrl) {
        ...
        args.putString(ChatChannelListFragment.EXTRA_GROUP_CHANNEL_URL, channelUrl);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mChannelUrl = getArguments().getString(ChatChannelListFragment.EXTRA_GROUP_CHANNEL_URL);
        }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRootLayout = (RelativeLayout) rootView.findViewById(R.id.layout_chat_root);
        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.recycler_chat);
        ...
        mUploadFileButton = (ImageButton) rootView.findViewById(R.id.button_chat_upload);
