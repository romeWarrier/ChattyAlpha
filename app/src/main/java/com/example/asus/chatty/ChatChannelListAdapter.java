...
//Display a list of Chat Channel
...
import com.example.asus.chatty.utils.DateUtils;
import com.example.asus.chatty.utils.FileUtils;
import com.example.asus.chatty.utils.TextUtils;
import com.example.asus.chatty.utils.TypingIndicator;
...
public class ChatChannelListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    ChatChannelListAdapter(Context context) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_chat_channel, parent, false);
    ...
    void updateOrInsert(BaseChannel channel) {
        ...
        for (int i = 0; i < mChannelList.size(); i++) {
            if (mChannelList.get(i).getUrl().equals(groupChannel.getUrl())) {
                ...
                notifyDataSetChanged();
                Log.v(ChatChannelListAdapter.class.getSimpleName(), "Channel replaced.");
                return;
            }
        }
    ...
    private class ChannelHolder extends RecyclerView.ViewHolder {
        ...
        ChannelHolder(View itemView) {
            ...
            topicText = (TextView) itemView.findViewById(R.id.text_chat_channel_list_topic);
            lastMessageText = (TextView) itemView.findViewById(R.id.text_chat_channel_list_message);
            unreadCountText = (TextView) itemView.findViewById(R.id.text_chat_channel_list_unread_count);
            dateText = (TextView) itemView.findViewById(R.id.text_chat_channel_list_date);
            memberCountText = (TextView) itemView.findViewById(R.id.text_chat_channel_list_member_count);
            coverImage = (MultiImageView) itemView.findViewById(R.id.image_chat_channel_list_cover);
            coverImage.setShape(MultiImageView.Shape.CIRCLE);

            typingIndicatorContainer = (LinearLayout) itemView.findViewById(R.id.container_chat_channel_list_typing_indicator);
        }
